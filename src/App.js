...
function App() {
  ...
  const sendAlert = () => {
    alert("Nothing interesting here...")
  }
    ...
    <div className="App">
      <header className="App-header">
        ...
        <div className='App-info'>
          ...
          <p>
            You are viewing our NEW FEATURE on the <span color={envColor}>{envName.toLocaleUpperCase()} Environment</span>
          </p>
          <button className='App-button' onClick={sendAlert}>Find Interesting Stuff</button>
        </div>
